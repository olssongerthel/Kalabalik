...
passport.use(
  new Strategy({ qop: 'auth' }, function (username, password, cb) {
...
if (settings.mssql.databases.invoicing) {
  ...
  app.route('/orders/:id').get(orders.findById).put(orders.update)
  ...
  app.route('/line-items/:order/:row').get(lineItems.findByOrderAndRow).put(lineItems.update)
  app.get('/customers', customers.index)
  app.route('/customers/:id').get(customers.findById).put(customers.update)
  app.get('/products', products.index)
  app.route('/products/:sku').get(products.findBySKU).put(products.update)
...
if (settings.mssql.databases.supplier) {
  ...
  app.route('/suppliers/:id').get(suppliers.findById)
  app.get('/purchase-orders', purchaseOrders.index)
  app.route('/purchase-orders/:id').get(purchaseOrders.findById).put(purchaseOrders.update)
  ...
  app
    .route('/purchase-order-line-items/:order/:row')
